...
import create_wallet_casper from "../../scripts/create_wallet_casper"

const create_wallet_local = (password) => {
  if (meets_password_criteria(password)) {
    store_password(password);
    create_wallet_casper();
...
const CreateWalletCasper = () => {
  ...
  return (
    <div style={styles.parentStyle}>
      ...
      <h2 className="display-3" style={{ color: colors["black-text"] }}>Casper Wallet</h2>
...
export default CreateWalletCasper;
