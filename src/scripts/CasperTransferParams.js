...
export const PAYMENT_AMOUNTS = {
    MINT_ONE_PAYMENT_AMOUNT:
      process.env.REACT_APP_MINT_ONE_PAYMENT_AMOUNT || '5000000000',
    MINT_COPIES_PAYMENT_AMOUNT:
      process.env.REACT_APP_MINT_COPIES_PAYMENT_AMOUNT || '100000000000',
    ...
    TRANSFER_ONE_PAYMENT_AMOUNT:
      process.env.REACT_APP_TRANSFER_ONE_PAYMENT_AMOUNT || '2000000000',
  };
