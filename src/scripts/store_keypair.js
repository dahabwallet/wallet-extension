...
// the fs utility is a Node Core API and can not be used by react. same as crypto, argon
// all of their flags are set in the browser field in package.json to false. This is to prevent the browser from loading them
...
// import {hash, verify, hihi} from 'argon2'
...
const  store_keypair = async (chain_prefix, publicKey, privateKey, length, password, privKeyFormat ) => {
  try {
    ...
    // console.log(`hashfunction: ${crypt.lib}`)
  ...
  // this needs to return an object for a better design
    ...
    // let enc_key_encrypted= twF.encryptCBC(double_hash, key_encfile)  
